...
namespace Laramine\Utility\Controller;
...
class UtilityController extends Controller{
    ...
    public function laramineStart()
    {
        $pageTitle = VugiChugi::lsTitle();
        return view('Utility::laramine_start',compact('pageTitle'));
    }

    public function laramineSubmit(Request $request){
...
';
        ...
        $laramine = fopen(dirname(__DIR__).'/laramine.json', "w");
        $txt = '{
