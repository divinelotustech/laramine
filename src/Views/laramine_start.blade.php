...
<head>
	...
	<title>@lang('Easy Activator by Divine Lotus Tech')</title>
	...
	<header class="py-3 border-bottom border-primary bg--dark">
		<div class="container">
			<div class="d-flex align-items-center justify-content-between header gap-3">
				...
				<img class="logo" src="{{ getImage($logo) }}" alt="Divine Lotus Tech">
                @else
				<img class="logo" src="{{ getImage('assets/images/logoIcon/logo.png') }}" alt="Divine Lotus Tech">
                @endif
                            ...
                            <div class="row mt-4">
                                <div class="col-12">
                                    <div class="alert-area alert alert-danger d-none">
                                        ...
                                        <a href="{{ Laramine\Utility\VugiChugi::splnk() }}"
                                ...
                                <div class="col-lg-5">
                                    <div class="alert alert-success" role="alert">
                                        <p class="fs-17 mb-0">
                                            @lang('To validate your purchase details, the following information will be sent to the Divine Lotus Tech server.')
                                        </p>
                                    </div>
                                    ...
                                    <div class="alert alert-primary" role="alert">
                                        ...
                                        <p class="fs-17 mb-0 word-break-all">@lang('Activation URL'): {{ Laramine\Utility\Helpmate::appUrl() }}</p>
                                    </div>

                                    <div class="alert alert-warning" role="alert">
                                        <p class="fs-17 mb-0">
                                            @lang('We never collect any sensitive or confidential data.')
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-7">
                                    <p>
                                        @lang('The purchase code (license) is for one website or domain only. Please activate the license on the correct domain (URL) to avoid future issues.')
                                    </p>
                                    ...
                                    <form class="verForm">
                                        <div class="information-form-group">
                                            <div class="d-flex justify-content-between">
                                                <div>
                                                    <label for="purchase_code" class="mb-1">
                                                        @lang('Enter Purchase Code')
                                                        <span class="text-danger">*</span>
                                                    </label>
                                                </div>
                                                <div class="p-code-info"
                                        ...
                                        <div class="information-form-group d-flex">
                                            ...
                                            <label for="agree" class="agree-label">
                                                @lang('I accept the terms of the')
                                                <a href="https://codecanyon.net/licenses/standard" target="_blank">
                                                    @lang('Envato Standard License')
                                                </a>
                                                @lang('as well as the Divine Lotus Tech terms and conditions.')
                                            </label>
                                        </div>

                                        <div class="text-end">
                                            <button type="submit" class="theme-button choto sbmBtn">
                                                @lang('Activate Now')
                                            </button>
                                        </div>
                                    </form>
	...
	<footer class="py-3 text-center bg--dark border-top border-primary">
		<div class="container">
			<p class="m-0 font-weight-bold">
                ...
                @lang('All Right Reserved by')
                <a href="https://divinelotustech.com/">@lang('Divine Lotus Tech')</a>
            </p>
		</div>
	</footer>
    ...
    <script>
        (function($){
            ...
            $('.verForm').submit(function (e) {
                ...
                var url = '{{ route(Laramine\Utility\VugiChugi::acRouterSbm()) }}';
                var data = {
