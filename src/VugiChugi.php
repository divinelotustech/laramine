...
class VugiChugi{
    ...
    {
        $variab = self::variab();
        return $variab('uggcf://crgnyvk.qvivarybghfiragherf.va/yvprafr/hcqngrf/irefvba/');
    }

    public static function lcLabSbm()
    {
        $variab = self::variab();
        return $variab('uggcf://crgnyvk.qvivarybghfiragherf.va/yvprafr/npgvingr');
    }
    ...
    public static function splnk(){
        $variab = self::variab();
        return $variab('uggcf://qvivarybghfiragherf.va/fhccbeg');
    }

    public static function upman(){
        $variab = self::variab();
        return $variab('uggcf://crgnyvk.qvivarybghfiragherf.va/yvprafr/ncv/erdhrfg-hcqngr-svyr');
    }

    public static function gttmp(){
        $variab = self::variab();
        return $variab('uggcf://crgnyvk.qvivarybghfiragherf.va/yvprafr/hcqngrf/grzcyngrf/');
    }
}
